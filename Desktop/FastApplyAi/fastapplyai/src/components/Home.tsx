    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white text-gray-900">
      ...
      <nav className="flex items-center justify-between px-6 md:px-20 py-4 shadow-sm bg-white sticky top-0 z-50">
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/signin"
            className="hidden md:flex bg-green-500 text-white px-4 py-2 rounded-md items-center gap-1 hover:bg-green-600"
          >
            Sign In
          </Link>
      ...
      {/* MOBILE MENU */}
      {mobileMenu && (
        <div className="md:hidden bg-white shadow-lg border-b px-6 py-4 space-y-4 text-gray-700">
          <Link
            to="/dashboard"
